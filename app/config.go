...
type options struct {
	...
	Colors struct {
		Accent       string `long:"color-accent"      ini-name:"color-accent"      env:"REVDIFF_COLOR_ACCENT"      default:"#7A8FA6" description:"active pane borders and directory names"`
		Border       string `long:"color-border"      ini-name:"color-border"      env:"REVDIFF_COLOR_BORDER"      default:"#525252" description:"inactive pane borders"`
		Normal       string `long:"color-normal"      ini-name:"color-normal"      env:"REVDIFF_COLOR_NORMAL"      default:"#D4D4D4" description:"file entries and context lines"`
		Muted        string `long:"color-muted"       ini-name:"color-muted"       env:"REVDIFF_COLOR_MUTED"       default:"#737373" description:"line numbers and status bar"`
		SelectedFg   string `long:"color-selected-fg" ini-name:"color-selected-fg" env:"REVDIFF_COLOR_SELECTED_FG" default:"#1C1917" description:"selected file text color"`
		SelectedBg   string `long:"color-selected-bg" ini-name:"color-selected-bg" env:"REVDIFF_COLOR_SELECTED_BG" default:"#7A8FA6" description:"selected file background color"`
		Annotation   string `long:"color-annotation"  ini-name:"color-annotation"  env:"REVDIFF_COLOR_ANNOTATION"  default:"#E5B567" description:"annotation text and markers"`
		CursorFg     string `long:"color-cursor-fg"   ini-name:"color-cursor-fg"   env:"REVDIFF_COLOR_CURSOR_FG"   default:"#D6A85F" description:"diff cursor indicator color"`
		...
		AddFg        string `long:"color-add-fg"      ini-name:"color-add-fg"      env:"REVDIFF_COLOR_ADD_FG"      default:"#A3C98B" description:"added line text color"`
		AddBg        string `long:"color-add-bg"      ini-name:"color-add-bg"      env:"REVDIFF_COLOR_ADD_BG"      default:"#1E3328" description:"added line background color"`
		RemoveFg     string `long:"color-remove-fg"   ini-name:"color-remove-fg"   env:"REVDIFF_COLOR_REMOVE_FG"   default:"#E58A8A" description:"removed line text color"`
		RemoveBg     string `long:"color-remove-bg"   ini-name:"color-remove-bg"   env:"REVDIFF_COLOR_REMOVE_BG"   default:"#3A2427" description:"removed line background color"`
		...
		ModifyFg     string `long:"color-modify-fg"      ini-name:"color-modify-fg"      env:"REVDIFF_COLOR_MODIFY_FG"      default:"#DDBA72" description:"modified line text color (collapsed mode)"`
		ModifyBg     string `long:"color-modify-bg"   ini-name:"color-modify-bg"   env:"REVDIFF_COLOR_MODIFY_BG"   default:"#382F20" description:"modified line background color (collapsed mode)"`
		...
		StatusFg     string `long:"color-status-fg"   ini-name:"color-status-fg"   env:"REVDIFF_COLOR_STATUS_FG"   default:"#CDD6F4" description:"status bar foreground"`
		StatusBg     string `long:"color-status-bg"   ini-name:"color-status-bg"   env:"REVDIFF_COLOR_STATUS_BG"   default:"#313244" description:"status bar background"`
		SearchFg     string `long:"color-search-fg"   ini-name:"color-search-fg"   env:"REVDIFF_COLOR_SEARCH_FG"   default:"#1C1917" description:"search match foreground"`
		SearchBg     string `long:"color-search-bg"   ini-name:"color-search-bg"   env:"REVDIFF_COLOR_SEARCH_BG"   default:"#C9A85F" description:"search match background"`
	} `group:"color options"`
